...
export const text = {
  th: {
    ...
    controls: "ผลกลุ่มเปรียบเทียบ",
    audit: "ตรวจสอบการแก้ไข",
    auditDescription: "ตรวจสอบการเปลี่ยนแปลงย้อนหลังตามตาราง ระเบียน ผู้ปฏิบัติงาน และช่วงเวลา",
    historyFilters: "ตัวกรองประวัติ",
    table: "ตาราง",
    recordId: "รหัสระเบียน",
    operatorId: "รหัสผู้ปฏิบัติงาน",
    from: "ตั้งแต่",
    to: "ถึง",
    clear: "ล้างตัวกรอง",
    loadMore: "โหลดรายการเพิ่มเติม",
    loading: "กำลังโหลด…",
    noAuditMatches: "ไม่พบประวัติที่ตรงกับตัวกรอง",
    action: "การกระทำ",
    record: "ระเบียน",
    ...
    promotionRejected:
      "\u0e01\u0e32\u0e23\u0e40\u0e25\u0e35\u0e49\u0e22\u0e07\u0e1b\u0e25\u0e32\u0e16\u0e39\u0e01\u0e1b\u0e0f\u0e34\u0e40\u0e2a\u0e18; \u0e15\u0e23\u0e27\u0e08\u0e2a\u0e2d\u0e1a\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07",
    confirmSelected: "\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e17\u0e35\u0e48\u0e40\u0e25\u0e37\u0e2d\u0e01",
    noEligiblePromotions:
      "\u0e22\u0e31\u0e07\u0e44\u0e21\u0e48\u0e21\u0e35\u0e15\u0e31\u0e27\u0e2d\u0e48\u0e2d\u0e19\u0e17\u0e35\u0e48\u0e40\u0e02\u0e49\u0e32\u0e40\u0e01\u0e13\u0e11\u0e4c",
    queued: "\u0e23\u0e2d\u0e2a\u0e48\u0e07",
    confirm: "\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19",
    controlCountsSaved:
  ...
  en: {
    ...
    auditDescription: "Review changes by table, record, operator, or time window.",
    ...
    loadMore: "Load more",
    loading: "Loading…",
    noAuditMatches: "No audit records match these filters",
    action: "Action",
    record: "Record",
    operator: "Operator",
    device: "Device",
