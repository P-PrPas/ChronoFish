...
--     (PostgreSQL TIMESTAMP / MySQL DATETIME(3)) — never a zone-aware type
...
CREATE TABLE injection_lot (
    ...
    enu_start_at         TIMESTAMP        NULL,
    enu_finish_at        TIMESTAMP        NULL,
    activated_at         TIMESTAMP    NOT NULL,   -- T0 for the whole system (BR-01)
    n_eggs               INTEGER          NULL,
