...
-- Source: backend/db/migrations/postgres/000007_query_path_indexes.up.sql
...
CREATE INDEX ix_embryo_lot_active_exit ON embryo (injection_lot_id, active, deleted_at, exit_reason);
